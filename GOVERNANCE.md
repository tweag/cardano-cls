...
This document describes how the Cardano Canonical Ledger state project is governed and
how decisions are made.

## Overview

The cardano-cls is an open-source project maintained under the
[Tweag by Modus Create](https://github.com/tweag) organisation. The project
